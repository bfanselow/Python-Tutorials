"""
 Problem: Find a generic formula for calulcating the sum of the diagonal elements of an NxN matrix M
...
# Identify diagonal matrix indices from bottom-left to top right (ignoring center element which is already counted)
...
## Putting this all together a function
