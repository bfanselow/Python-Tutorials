"""
  ...
  Description: 
    ...
    2) Storing all previously processed input and outputs can place
       ...
       system load with tests while adjusting MAX_KEYS. Use this only when there 
       are observable advanatages to caching which out-weigh the disadvantage 
       of memory load. For example, when processing time is very large and the
       number of unique function inputs is small.
